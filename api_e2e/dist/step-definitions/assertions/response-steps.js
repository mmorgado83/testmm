...
(0, _cucumber.Then)(/^the response was (successful)?(unsuccessful)?$/, /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(success, unsuccessful) {
...
(0, _cucumber.Then)(/^the response json contains the attributes:$/, /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(dataTable) {
